          ...
          <form action="#">
            <div class="form-row">
                <%
                    ...
                    List collegelist=AlumniCon.getCollegeList();
                %>
              ...
              <div class="col">
                 ...
                 { %>
                <select name="college" id="type" class="form-control">
                  <option value="College">College</option>
                  <% for(i=0;i<collegelist.size();i++)
                {
               %>
                    <option value="<%=collegelist.get(i)%>"><%=collegelist.get(i)%></option>
               <% }
        ...
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            System.out.print(" )))))))))))))))))) "+college);
               ...
               lcollege=collegelist.get(0).toString();
            ...
            if(year==null && dept==null && college==null)
            {
                alumnilist=AlumniCon.getAllAlumni();
            }
            else if(year.equals("Year") && college.equals("College") && dept.equals("Department"))
                alumnilist=AlumniCon.getAllAlumni();
            else
                alumnilist=AlumniCon.returnFilteredAlumniClg(year, dept, college);%>
            
                 <% if(alumnilist.size()!=0)
                        { 
                            System.out.print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1   "+alumnilist.size());
